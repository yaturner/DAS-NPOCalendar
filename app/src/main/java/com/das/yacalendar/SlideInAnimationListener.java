 ...
 * @author yaturner
 */
public class SlideInAnimationListener implements AnimationListener
{
    private yacalendar mMainApp = null;

    public SlideInAnimationListener(final yacalendar mainApp)
    {
    ...
    {
        mMainApp.mCurrentMonthView.setVisibility(View.VISIBLE);
    }
